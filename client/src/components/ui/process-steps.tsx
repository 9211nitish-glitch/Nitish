...
export default function ProcessSteps() {
  return (
    <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-800" data-testid="process-steps-section">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h6 className="text-blue-400 font-semibold mb-4 tracking-wider uppercase">Start As Influencer</h6>
          <h2 className="text-3xl md:text-5xl font-bold mb-6" data-testid="process-steps-title">
        ...
        <div className="text-center mt-16">
          ...
          <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-xl font-semibold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg">
