...
import EnhancedParticles from "@/components/3d/enhanced-particles";
import InteractiveSphere from "@/components/3d/interactive-sphere";
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900/20 to-purple-900/20 overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-32 h-32 opacity-20">
        <InteractiveSphere size={2} color="#8B5CF6" wireframe={true} />
      </div>
